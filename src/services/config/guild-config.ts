...
import type { GuildAIConfig, Prisma } from '.prisma/fumblebot'
...
export async function updateGuildAIConfig(
  ...
  if (updates.customSettings !== undefined) updateData.customSettings = updates.customSettings as Prisma.JsonValue
