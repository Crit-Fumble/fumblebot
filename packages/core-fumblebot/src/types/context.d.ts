 ...
 */
export declare function getMessageLink(guildId: string, channelId: string, messageId: string): string;
/**
 ...
 */
export type GameSystem = '5e' | 'pf2e' | 'pf1e' | 'cypher' | 'bitd' | 'swn' | 'mothership' | 'coc' | 'fate' | 'pbta' | 'savage' | 'dcc' | 'osr' | 'other';
/**
 ...
 */
export declare const GAME_SYSTEM_NAMES: Record<GameSystem, string>;
/**
 * Types of internal AI reasoning
 */
export type ThoughtType = 'question' | 'reasoning' | 'lookup' | 'decision' | 'summary' | 'filter' | 'context';
/**
 ...
 */
export type LookupType = 'spell' | 'monster' | 'item' | 'rules' | 'lore' | 'class' | 'race' | 'feat' | 'condition' | 'general';
/**
