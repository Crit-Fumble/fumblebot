...
export type ActivityType = 'dice-roller' | 'character-sheet' | 'map-viewer' | 'initiative-tracker' | 'spell-lookup' | 'custom';
...
export declare const WEB_FETCH_ALLOWED_DOMAINS: readonly ["5e.tools", "dndbeyond.com", "foundryvtt.com/kb/", "callmepartario.github.io"];
